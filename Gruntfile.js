...
module.exports = function (grunt) {
    ...
    grunt.registerTask('publish', ['sketch_export:run', 'shell:svgfromsubfolder', 'shell:svgrename', 'replace:remove_mask', 'webfont:run', 'rename:main', 'embedFonts', 'json_generator', 'shell:svgcopytobuild', 'shell:publish']);
    grunt.registerTask('default', ['sketch_export:run', 'shell:svgfromsubfolder', 'shell:svgrename', 'replace:remove_mask', 'webfont:run', 'rename:main', 'embedFonts', 'json_generator', 'shell:svgcopytobuild', ]);
};
